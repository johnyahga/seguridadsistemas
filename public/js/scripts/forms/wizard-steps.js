...
$(".wizard-fase01").steps({
  ...
  onFinished: function (event, currentIndex) {
    $(".wizard-fase01").submit();
  }
});


$(".wizard-alta-tramite").steps({
  headerTag: "h6",
  bodyTag: "fieldset",
  transitionEffect: "fade",
  titleTemplate: '<span class="step">#index#</span> #title#',
...
$(".actions [href='#next']").click(function () {
  ...
  // agregar codigo para guardado por fase aqui
  console.log('cambiando de fase en el formulario');
  // agregar codigo para guardado por fase aqui
